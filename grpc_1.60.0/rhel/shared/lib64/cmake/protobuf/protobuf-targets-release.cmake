...
set_target_properties(protobuf::libprotobuf-lite PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libprotobuf-lite.so.25.0.0"
  IMPORTED_SONAME_RELEASE "libprotobuf-lite.so.25.0.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS protobuf::libprotobuf-lite )
list(APPEND _IMPORT_CHECK_FILES_FOR_protobuf::libprotobuf-lite "${_IMPORT_PREFIX}/lib64/libprotobuf-lite.so.25.0.0" )
...
set_target_properties(protobuf::libprotobuf PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libprotobuf.so.25.0.0"
  IMPORTED_SONAME_RELEASE "libprotobuf.so.25.0.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS protobuf::libprotobuf )
list(APPEND _IMPORT_CHECK_FILES_FOR_protobuf::libprotobuf "${_IMPORT_PREFIX}/lib64/libprotobuf.so.25.0.0" )
...
set_target_properties(protobuf::libprotoc PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libprotoc.so.25.0.0"
  IMPORTED_SONAME_RELEASE "libprotoc.so.25.0.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS protobuf::libprotoc )
list(APPEND _IMPORT_CHECK_FILES_FOR_protobuf::libprotoc "${_IMPORT_PREFIX}/lib64/libprotoc.so.25.0.0" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_protobuf::protoc "${_IMPORT_PREFIX}/bin/protoc-25.0.0" )
